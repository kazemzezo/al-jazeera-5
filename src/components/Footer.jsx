...
// ════════════════════════════════════════════
const CONTENT = {
  // ساحة المنافسه العادله لكل التجار وصغار المستثمرين
  tagline:
    "لكل تاجر صغير يحلم ينافس في السوق بفرص متساوية. مع الجزيره خمسه، الحجم مش عائق — تقدر تشتري على قد شركتك، وتستثمر بذكاء، وتكبر كل يوم.",
