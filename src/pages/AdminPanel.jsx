...
function UsersTab({ adminUid }) {
  ...
  return (
    <div>
      ...
      >
        🔐 تاب مخصص للأدمن الأساسي فقط. تقدر من هنا تغيير دور أي مستخدم أو
        تعليق حسابه. حساب الأدمن الأساسي محمي ولا يظهر هنا.
      </div>
              ...
              >
                ...
                {isEditing && (
                  ...
                  >
                    ...
                    >
                      ⚠️ تغيير الدور يؤثر فوراً على صلاحيات المستخدم.
                    </p>
                  </div>
                )}
              </div>
